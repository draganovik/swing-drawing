...
public class DlgManageHexagon extends JDialog {
	...
	public static void main(String[] args) {
		try {
			DlgManageHexagon dialog = new DlgManageHexagon();
	...
	public DlgManageHexagon(HexagonAdapter hexagon) {
		this();
		this.hexagon = hexagon;
		txtCoordinateX.setText(Integer.toString(hexagon.getCenter().getX()));
		txtCoordinateY.setText(Integer.toString(hexagon.getCenter().getY()));
		txtRadius.setText(Integer.toString(hexagon.getRadius()));
	}

	public void updateShape() {
		try {
			Point hexagonCentar = hexagon.getCenter();
			hexagonCentar.setX(Integer.parseInt(this.txtCoordinateX.getText()));
			hexagonCentar.setY(Integer.parseInt(this.txtCoordinateY.getText()));
